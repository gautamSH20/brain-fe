...
export const EditCard = ({ open, onClose, _id }: ComponentProp) => {
  ...
  async function updateContent() {
    ...
    try {
      ...
      if (put.data.message !== "something is wrong") onClose();
      else alert(put.data.message);
    } catch (e) {
  ...
  return (
    <div>
      {open && (
        <div>
          <div className="h-screen w-screen fixed top-0 left-0 bg-slate-500 opacity-80 "></div>
